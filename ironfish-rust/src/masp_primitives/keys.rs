...
pub mod testing {
    ...
    use crate::masp_primitives::primitives::PaymentAddress;
    use crate::masp_primitives::zip32::{ExtendedFullViewingKey, ExtendedSpendingKey};
...
mod tests {
    ...
    use crate::masp_primitives::constants::SPENDING_KEY_GENERATOR;
